...
public final class ModBlocks {
    ...
    public static final Block CONSTRUCTOR_BOX = register(new BlockConstructor(Block.Properties.create(Material.WOOD, MaterialColor.BROWN),"constructor_box"));
    public static final Block CONTROL_BOX = register(new BlockControlBox(Block.Properties.create(Material.ROCK,MaterialColor.GRAY),"control_box"));
